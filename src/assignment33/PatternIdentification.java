...
BufferedReader br= new BufferedReader(new FileReader("C:\\Users\\ANKITGHO\\OneDrive - Capgemini\\Desktop\\Assignment 4\\Assignemnt 4\\src\\assignment33\\team.txt"));
str= br.readLine();
}
...
for(int j=0;j<n;j++)
{
PatternIdentification obj= new PatternIdentification();
